...
function templateEnem61Dias_() {
  ...
  var css = '<style>' +
    '@media only screen and (max-width:920px){' +
      ...
      '.hero-copy{width:56%!important;box-sizing:border-box!important;padding:24px!important;background:#f6eadc!important;}' +
      '.hero-title{font-size:27px!important;line-height:30px!important;color:#342748!important;letter-spacing:.3px!important;}' +
      '.hero-subtitle{font-size:15px!important;line-height:20px!important;color:#342748!important;}' +
      '.hero-body{font-size:13px!important;line-height:19px!important;color:#3f3943!important;}' +
  ...
  '<tr><td background="'+IMG.hero+'" style="background-image:url(\''+IMG.hero+'\');background-position:center center;background-size:cover;background-repeat:no-repeat;height:500px;padding:0;vertical-align:middle;">' +
    ...
    '<table role="presentation" width="100%" style="width:100%;border-collapse:collapse;"><tr>' +
      '<td class="hero-copy" style="width:41%;padding:34px 28px 34px 34px;vertical-align:middle;box-sizing:border-box;background:#f6eadc;">' +
        '<div class="hero-title" style="font-family:Palatino Linotype,Book Antiqua,Palatino,Georgia,serif;font-size:31px;line-height:34px;font-weight:400;letter-spacing:.4px;color:#342748;text-transform:uppercase;">FALTAM 61 DIAS<br>PARA O ENEM.</div>' +
        '<div class="hero-subtitle" style="font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:22px;font-weight:bold;color:#342748;margin-top:14px;">61 dias. 6 momentos. 1 objetivo.</div>' +
        '<div class="hero-body" style="font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:19px;color:#3f3943;margin-top:13px;">A reta final chegou. Entre conteúdos, revisões e simulados, também existe uma rotina que precisa caber nos seus dias.</div>' +
        '<div class="hero-body" style="font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:19px;color:#3f3943;font-weight:bold;margin-top:11px;">Você não precisa passar por isso no automático.</div>' +
      '</td>' +
