 ...
 * Versão final baseada no HTML aprovado.
 */
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;table-layout:fixed;border-top:1px solid #e8e1d6;border-bottom:1px solid #e8e1d6;">
                <tr>
                  <td class="menu-cell" style="width:16.66%;padding:12px 6px;text-align:center;border-right:1px solid #e8e1d6;">
                    <a href="https://essenciadobrasil.com.br/perfumes-masculinos/" style="text-decoration:none;color:#214d3a;font-size:10px;font-weight:bold;text-transform:uppercase;">
                  ...
                  <td class="menu-cell" style="width:16.66%;padding:12px 6px;text-align:center;border-right:1px solid #e8e1d6;">
                    <a href="https://www.essenciadobrasil.com.br/perfumes-femininos/" style="text-decoration:none;color:#214d3a;font-size:10px;font-weight:bold;text-transform:uppercase;">
                  ...
                  <td class="menu-cell" style="width:16.66%;padding:12px 6px;text-align:center;border-right:1px solid #e8e1d6;">
                    <a href="https://essenciadobrasil.com.br/oleos-essenciais/" style="text-decoration:none;color:#214d3a;font-size:10px;font-weight:bold;text-transform:uppercase;">
                  ...
                  <td class="menu-cell" style="width:16.66%;padding:12px 6px;text-align:center;border-right:1px solid #e8e1d6;">
                    <a href="https://essenciadobrasil.com.br/essencias/" style="text-decoration:none;color:#214d3a;font-size:10px;font-weight:bold;text-transform:uppercase;">
                  ...
                  <td class="menu-cell" style="width:16.66%;padding:12px 6px;text-align:center;border-right:1px solid #e8e1d6;">
                    <a href="https://essenciadobrasil.com.br/seruns-e-cremes/" style="text-decoration:none;color:#214d3a;font-size:10px;font-weight:bold;text-transform:uppercase;">
                  ...
                  <td class="menu-cell" style="width:16.66%;padding:12px 6px;text-align:center;">
                    <a href="https://www.essenciadobrasil.com.br/black-essencia-do-brasil/" style="text-decoration:none;color:#214d3a;font-size:10px;font-weight:bold;text-transform:uppercase;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;table-layout:fixed;">
                <tr>
                  ...
                  <td class="product-cell" valign="top" style="width:25%;padding:12px 8px;box-sizing:border-box;">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;table-layout:fixed;border:1px solid #d7c191;background-color:#fffaf1;">
                      ...
                      <tr><td align="center" style="padding:6px 8px 2px 8px;">
                        <a href="https://essenciadobrasil.com.br/produtos/gold-serum-avancado-com-ouro-silicio-e-hialuronico-30ml/" style="text-decoration:none;">
                          <img src="https://acdn-us.mitiendanube.com/stores/006/291/372/products/domv51r-29b1ff506964cebcfd17490484546173-1024-1024.webp" width="190" height="190" alt="Gold Sérum Avançado 30ml" style="display:block;width:100%;max-width:100%;height:auto;border:0;margin:0 auto;">
                        </a>
                      </td></tr>
                      <tr><td align="center" style="padding:8px 10px 0 10px;">
                        <div style="display:inline-block;width:64px;height:64px;line-height:64px;border-radius:50%;background-color:#2b1734;color:#ffffff;font-size:15px;font-weight:bold;text-align:center;vertical-align:middle;">70% OFF</div>
                  ...
                  <td class="product-cell" valign="top" style="width:25%;padding:12px 8px;box-sizing:border-box;">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;table-layout:fixed;border:1px solid #e4ddd2;background-color:#ffffff;">
                      <tr><td align="center" style="padding:12px 8px 6px 8px;">
                        <div style="display:inline-block;width:64px;height:64px;line-height:64px;border-radius:50%;background-color:#214d3a;color:#ffffff;font-size:15px;font-weight:bold;text-align:center;vertical-align:middle;">40% OFF</div>
                      </td></tr>
                      <tr><td align="center" style="padding:6px 8px 2px 8px;">
                  ...
                  <td class="product-cell" valign="top" style="width:25%;padding:12px 8px;box-sizing:border-box;">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;table-layout:fixed;border:1px solid #e4ddd2;background-color:#ffffff;">
                      <tr><td align="center" style="padding:12px 8px 6px 8px;">
                        <div style="display:inline-block;width:64px;height:64px;line-height:64px;border-radius:50%;background-color:#214d3a;color:#ffffff;font-size:15px;font-weight:bold;text-align:center;vertical-align:middle;">37% OFF</div>
                      </td></tr>
                      <tr><td align="center" style="padding:6px 8px 2px 8px;">
                  ...
                  <td class="product-cell" valign="top" style="width:25%;padding:12px 8px;box-sizing:border-box;">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;table-layout:fixed;border:1px solid #e4ddd2;background-color:#ffffff;">
                      <tr><td align="center" style="padding:12px 8px 6px 8px;">
                        <div style="display:inline-block;width:64px;height:64px;line-height:64px;border-radius:50%;background-color:#214d3a;color:#ffffff;font-size:15px;font-weight:bold;text-align:center;vertical-align:middle;">30% OFF</div>
                      </td></tr>
                      <tr><td align="center" style="padding:6px 8px 2px 8px;">
...
function validarEmail99Essencia_(html, inlineImages) {
  ...
  if (html.indexOf("VER AS OFERTAS") !== -1) {
    throw new Error('O botão "VER AS OFERTAS" voltou ao HTML, mas deveria estar removido.');
  }

  if (html.indexOf("Hoje não é um dia qualquer") !== -1) {
    // O assunto não precisa aparecer no corpo; apenas evita confundir validações futuras.
  }
