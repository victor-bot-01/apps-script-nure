...
function templateEnem61Dias_() {
  ...
  var css = '<style>' +
    '@media only screen and (max-width:920px){' +
      ...
      '.hero-mobile-cell{display:table-cell!important;height:350px!important;background-size:100% auto!important;background-position:center top!important;background-repeat:no-repeat!important;}' +
      '.hero-mobile-copy{width:34%!important;max-width:34%!important;box-sizing:border-box!important;padding:18px 0 10px 22px!important;text-align:left!important;vertical-align:top!important;}' +
      '.hero-mobile-title{font-size:12px!important;line-height:15px!important;color:#312a5b!important;font-family:Arial,Helvetica,sans-serif!important;font-weight:700!important;letter-spacing:.8px!important;}' +
      '.hero-mobile-number{font-size:74px!important;line-height:66px!important;color:#373064!important;font-family:Georgia,Times New Roman,serif!important;font-weight:400!important;}' +
      '.hero-mobile-days{font-size:11px!important;line-height:14px!important;color:#373064!important;padding:4px 7px!important;margin-left:1px!important;}' +
      '.hero-mobile-enem{font-size:21px!important;line-height:23px!important;color:#373064!important;font-family:Brush Script MT,Segoe Print,cursive!important;}' +
      '.hero-mobile-subtitle{font-size:9px!important;line-height:12px!important;color:#1c1821!important;font-family:Arial,Helvetica,sans-serif!important;font-weight:700!important;}' +
      '.hero-mobile-body{font-size:9px!important;line-height:12px!important;color:#1c1821!important;font-family:Arial,Helvetica,sans-serif!important;}' +
      '.hero-mobile-final{font-size:10px!important;line-height:13px!important;color:#373064!important;font-family:Brush Script MT,Segoe Print,cursive!important;}' +
  ...
  // 4B. Hero mobile — usa a imagem inteira na largura (sem cover), evitando o recorte que jogava o texto sobre o caderno.
  '<tr class="hero-mobile" style="display:none;max-height:0;overflow:hidden;mso-hide:all;">' +
    '<td class="hero-mobile-cell" background="'+IMG.hero+'" style="display:none;background-image:url(\''+IMG.hero+'\');background-size:100% auto;background-position:center top;background-repeat:no-repeat;height:350px;padding:0;vertical-align:top;">' +
      '<table role="presentation" width="100%" style="width:100%;border-collapse:collapse;"><tr>' +
        '<td class="hero-mobile-copy" style="width:34%;padding:18px 0 10px 22px;vertical-align:top;text-align:left;box-sizing:border-box;">' +
          '<div class="hero-mobile-title" style="display:inline-block;background:#efc94f;color:#312a5b;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:15px;font-weight:700;letter-spacing:.8px;padding:4px 7px;">FALTAM</div>' +
          '<div style="white-space:nowrap;line-height:1;margin-top:2px;">' +
            '<span class="hero-mobile-number" style="display:inline-block;vertical-align:middle;font-family:Georgia,Times New Roman,serif;font-size:74px;line-height:66px;font-weight:400;color:#373064;">61</span>' +
            '<span class="hero-mobile-days" style="display:inline-block;vertical-align:middle;background:#efc94f;color:#373064;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:14px;font-weight:700;letter-spacing:.8px;padding:4px 7px;margin-left:1px;">DIAS</span>' +
          '</div>' +
          '<div class="hero-mobile-enem" style="font-family:Brush Script MT,Segoe Print,cursive;font-size:21px;line-height:23px;font-style:italic;color:#373064;margin-top:-1px;">PARA O ENEM!</div>' +
          '<div class="hero-mobile-subtitle" style="font-family:Arial,Helvetica,sans-serif;font-size:9px;line-height:12px;font-weight:700;color:#1c1821;margin-top:7px;">61 dias. 6 momentos. 1 objetivo.</div>' +
          '<div class="hero-mobile-body" style="font-family:Arial,Helvetica,sans-serif;font-size:9px;line-height:12px;color:#1c1821;margin-top:5px;">A reta final chegou. Entre conteúdos, revisões e simulados, também existe uma rotina que precisa caber nos seus dias.</div>' +
          '<div class="hero-mobile-final" style="display:inline-block;font-family:Brush Script MT,Segoe Print,cursive;font-size:10px;line-height:13px;font-style:italic;color:#373064;margin-top:6px;border-bottom:2px solid #d99354;padding-bottom:1px;">Você não precisa passar por isso no automático. ♡</div>' +
        '</td>' +
...
function validarTemplateEnem61Dias_() {
  ...
  // Regras 20/22: hero mobile independente, sem recorte cover.
  [
   '.hero-desktop{display:none!important;max-height:0!important;overflow:hidden!important;mso-hide:all!important;}',
   '.hero-mobile{display:table-row!important;max-height:none!important;overflow:visible!important;}',
   '.hero-mobile-cell{display:table-cell!important;height:350px!important;background-size:100% auto!important;background-position:center top!important;background-repeat:no-repeat!important;}',
   ...
   '.hero-mobile-final{font-size:10px!important;line-height:13px!important;color:#373064!important;font-family:Brush Script MT,Segoe Print,cursive!important;}'
    ...
    if (html.indexOf(rule) === -1) throw new Error('Falha regras 20/22: hero mobile independente ausente.');
  });
