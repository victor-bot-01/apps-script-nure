...
@media only screen and (max-width:920px){
  ...
  .header-col{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;text-align:center!important;}
  .brand-cell{padding:20px 20px 16px!important;text-align:center!important;}
  .brand-link{display:inline-block!important;margin:0 auto!important;text-align:center!important;}
  .brand-sub{padding-left:0!important;text-align:center!important;}
  .header-icons-cell{padding:8px 14px 18px!important;text-align:center!important;}
  ...
  .hero-copy{display:block!important;width:100%!important;max-width:100%!important;background-color:#193c2f!important;padding:30px 28px 28px!important;box-sizing:border-box!important;text-align:left!important;}
  .hero-spacer{display:block!important;width:100%!important;max-width:100%!important;padding:0!important;box-sizing:border-box!important;font-size:0!important;line-height:0!important;background-color:#193c2f!important;}
  .hero-mobile-image{display:block!important;width:100%!important;height:auto!important;max-width:100%!important;margin:0!important;border:0!important;}
  ...
  .section-heading-wrap{padding:22px 16px 14px!important;}
  .section-line-cell{display:table-cell!important;width:12%!important;max-width:12%!important;box-sizing:border-box!important;padding:0 5px!important;}
  .section-title-cell{display:table-cell!important;width:76%!important;max-width:76%!important;box-sizing:border-box!important;padding:0 2px!important;}
  .section-title{font-size:13px!important;line-height:17px!important;white-space:nowrap!important;word-break:normal!important;overflow-wrap:normal!important;letter-spacing:.35px!important;}
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;table-layout:fixed;border-collapse:collapse;">
<tr>
<td class="header-col brand-cell stack100" valign="middle" style="width:40%;padding:20px 28px 18px 48px;text-align:left;">
<a class="brand-link" href="https://essenciadobrasil.com.br/" style="text-decoration:none;color:#18382d;display:inline-block;">
...
<div class="brand-sub" style="font-family:Georgia,'Times New Roman',serif;font-size:15px;line-height:18px;letter-spacing:5px;color:#18382d;padding-left:18px;">DO BRASIL</div>
</a>
</td>
<td class="header-col header-icons-cell stack100" valign="middle" style="width:60%;padding:12px 24px 12px 8px;">
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;table-layout:fixed;border-collapse:collapse;">
<tr>
...
<!-- section heading -->
<tr><td class="section-heading-wrap" style="padding:24px 42px 14px;background-color:#fbf7ef;">
<table class="section-heading-table" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;">
...
'https://i.ibb.co/XkMZQmwD/Chat-GPT-Image-3-de-set-de-2026-18-59-39.png',
  ...
  var classesResponsivas = ['stack100','header-col','menu-cell','benefit-cell','product-cell','secondary-col','offer-cell','footer-col','bottom-col','hero-copy','hero-spacer','section-title-cell','section-line-cell'];
  ...
  tabelas.forEach(function(tag) {
    ...
    var sectionHeading = /class="[^"]*section-heading-table/i.test(tag);
    if (eh100 && !heroSplit && !sectionHeading && !/table-layout:fixed/i.test(tag)) {
  ...
  if (html.indexOf('.hero-mobile-image{display:block!important;width:100%!important;height:auto!important;max-width:100%!important;margin:0!important;border:0!important;}') === -1) {
    throw new Error('Imagem hero mobile integral/sem corte ausente.');
  }
  if (html.indexOf('.header-col{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;text-align:center!important;}') === -1 ||
      html.indexOf('.brand-sub{padding-left:0!important;text-align:center!important;}') === -1) {
    throw new Error('Centralização mobile da marca/cabeçalho ausente.');
  }
  if (html.indexOf('.section-heading-wrap{padding:22px 16px 14px!important;}') === -1 ||
      html.indexOf('.section-line-cell{display:table-cell!important;width:12%!important;max-width:12%!important;box-sizing:border-box!important;padding:0 5px!important;}') === -1 ||
      html.indexOf('.section-title{font-size:13px!important;line-height:17px!important;white-space:nowrap!important;') === -1) {
    throw new Error('Título mobile Conheça as 6 Composições não está em linha única com traços laterais.');
  }
  if (html.indexOf('class="section-heading-table"') === -1) {
    throw new Error('Tabela especial do título da seção ausente.');
  }
