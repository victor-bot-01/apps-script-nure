...
function templateEnem61Dias_() {
  ...
  var css = '<style>' +
    '@media only screen and (max-width:920px){' +
      ...
      '.hero-bg{background-position:78% center!important;}' +
      '.hero-copy{width:62%!important;box-sizing:border-box!important;padding:26px 16px 24px 46px!important;background:transparent!important;}' +
      ...
      '.hero-subtitle{font-size:12px!important;line-height:17px!important;color:#15131c!important;font-family:Arial,Helvetica,sans-serif!important;font-weight:400!important;}' +
      '.hero-body{font-size:11px!important;line-height:16px!important;color:#15131c!important;font-family:Arial,Helvetica,sans-serif!important;}' +
      ...
      '.hero-final{font-size:14px!important;line-height:18px!important;color:#292454!important;}' +
