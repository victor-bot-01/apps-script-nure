...
function blocoTituloProdutosRockInRio2026_() {
  ...
  html.push('<div class="section-title" style="font-family:Georgia,\'Times New Roman\',serif;font-size:29px;line-height:35px;font-weight:700;color:#171922;margin:0 0 7px 0;word-break:keep-all;word-wrap:normal;overflow-wrap:normal;hyphens:none;-webkit-hyphens:none;-ms-hyphens:none;white-space:normal;"><span style="display:inline-block;white-space:nowrap;">6</span> <span style="display:inline-block;white-space:nowrap;">fragrâncias</span> <span style="display:inline-block;white-space:nowrap;">para</span> <span style="display:inline-block;white-space:nowrap;">entrar</span> <span style="display:inline-block;white-space:nowrap;">no</span> <span style="display:inline-block;white-space:nowrap;">ritmo</span> <span style="display:inline-block;white-space:nowrap;">da</span> <span style="display:inline-block;white-space:nowrap;">noite</span></div>');
...
function montarTemplateRockInRio2026_() {
  ...
  html.push('.section-title{font-size:24px!important;line-height:30px!important;word-break:keep-all!important;word-wrap:normal!important;overflow-wrap:normal!important;hyphens:none!important;-webkit-hyphens:none!important;-ms-hyphens:none!important;white-space:normal!important;}');
