...
function templateEnem61Dias_() {
  ...
  var css = '<style>' +
    '@media only screen and (max-width:920px){' +
      ...
      '.hero-copy{width:100%!important;box-sizing:border-box!important;padding:18px 0 18px 0!important;background:transparent!important;}' +
      '.hero-head{width:54%!important;max-width:54%!important;box-sizing:border-box!important;margin-left:8%!important;text-align:left!important;}' +
      '.hero-support{width:43%!important;max-width:43%!important;box-sizing:border-box!important;margin-left:9%!important;margin-top:8px!important;text-align:left!important;}' +
      '.hero-title{font-size:14px!important;line-height:17px!important;color:#1f1a35!important;font-family:Arial,Helvetica,sans-serif!important;font-weight:700!important;font-style:normal!important;padding:4px 8px!important;}' +
      '.hero-subtitle{font-size:12px!important;line-height:17px!important;color:#17131f!important;font-family:Arial,Helvetica,sans-serif!important;font-weight:700!important;text-shadow:0 1px 2px rgba(255,255,255,.95)!important;}' +
      '.hero-body{font-size:11px!important;line-height:16px!important;color:#17131f!important;font-family:Arial,Helvetica,sans-serif!important;text-shadow:0 1px 2px rgba(255,255,255,.95)!important;}' +
      '.hero-number{font-size:96px!important;line-height:84px!important;color:#292454!important;}' +
      '.hero-days{font-size:14px!important;line-height:17px!important;padding:4px 8px!important;margin-left:2px!important;}' +
      '.hero-enem{font-size:29px!important;line-height:31px!important;color:#292454!important;}' +
      '.hero-final{font-size:13px!important;line-height:17px!important;color:#292454!important;text-shadow:0 1px 2px rgba(255,255,255,.95)!important;}' +
  ...
  '<tr><td class="hero-bg" background="'+IMG.hero+'" style="background-image:url(\''+IMG.hero+'\');background-position:center center;background-size:cover;background-repeat:no-repeat;height:500px;padding:0;vertical-align:middle;">' +
