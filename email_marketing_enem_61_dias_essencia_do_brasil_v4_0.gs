...
function templateEnem61Dias_() {
  ...
  var css = '<style>' +
    '@media only screen and (max-width:920px){' +
      ...
      '.menu-cell{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;font-size:11px!important;line-height:15px!important;padding:12px 20px!important;text-align:center!important;}' +
      '.attribute-cell{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;padding:13px 24px!important;text-align:center!important;}' +
      '.attribute-cell img{margin-left:auto!important;margin-right:auto!important;}' +
      '.hero-desktop{display:none!important;max-height:0!important;overflow:hidden!important;mso-hide:all!important;}' +
      '.hero-mobile{display:table-row!important;max-height:none!important;overflow:visible!important;}' +
      '.hero-mobile-cell{display:table-cell!important;height:430px!important;background-position:60% center!important;background-size:cover!important;background-repeat:no-repeat!important;}' +
      '.hero-mobile-copy{width:48%!important;max-width:48%!important;box-sizing:border-box!important;padding:22px 6px 18px 30px!important;text-align:left!important;vertical-align:middle!important;}' +
      '.hero-mobile-title{font-size:14px!important;line-height:17px!important;color:#302a59!important;font-family:Arial,Helvetica,sans-serif!important;font-weight:700!important;letter-spacing:1px!important;}' +
      '.hero-mobile-number{font-size:82px!important;line-height:74px!important;color:#342f63!important;font-family:Georgia,Times New Roman,serif!important;font-weight:400!important;}' +
      '.hero-mobile-days{font-size:13px!important;line-height:16px!important;color:#342f63!important;padding:4px 8px!important;margin-left:2px!important;}' +
      '.hero-mobile-enem{font-size:25px!important;line-height:27px!important;color:#342f63!important;font-family:Brush Script MT,Segoe Print,cursive!important;}' +
      '.hero-mobile-subtitle{font-size:11px!important;line-height:15px!important;color:#18151f!important;font-family:Arial,Helvetica,sans-serif!important;font-weight:700!important;text-shadow:0 1px 1px #ffffff!important;}' +
      '.hero-mobile-body{font-size:10px!important;line-height:14px!important;color:#18151f!important;font-family:Arial,Helvetica,sans-serif!important;text-shadow:0 1px 1px #ffffff!important;}' +
      '.hero-mobile-final{font-size:12px!important;line-height:15px!important;color:#342f63!important;font-family:Brush Script MT,Segoe Print,cursive!important;text-shadow:0 1px 1px #ffffff!important;}' +
  ...
  // 4A. Hero desktop — preservado exatamente como aprovado.
  '<tr class="hero-desktop"><td background="'+IMG.hero+'" style="background-image:url(\''+IMG.hero+'\');background-position:center center;background-size:cover;background-repeat:no-repeat;height:500px;padding:0;vertical-align:middle;">' +
    ...
    '<table role="presentation" width="100%" style="width:100%;border-collapse:collapse;"><tr>' +
      '<td class="hero-copy" style="width:41%;padding:18px 14px 20px 34px;vertical-align:middle;box-sizing:border-box;background:transparent;">' +
        ...
        '<div style="white-space:nowrap;line-height:1;">' +
          '<span class="hero-number" style="display:inline-block;vertical-align:middle;font-family:Georgia,Times New Roman,serif;font-size:126px;line-height:108px;font-weight:400;color:#34315f;">61</span>' +
          '<span class="hero-days" style="display:inline-block;vertical-align:middle;background:#efc94f;color:#34315f;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;letter-spacing:1px;padding:5px 10px;margin-left:2px;transform:rotate(-2deg);">DIAS</span>' +
        '</div>' +
  ...
  // 4B. Hero mobile — estrutura independente do desktop.
  '<tr class="hero-mobile" style="display:none;max-height:0;overflow:hidden;mso-hide:all;">' +
    '<td class="hero-mobile-cell" background="'+IMG.hero+'" style="display:none;background-image:url(\''+IMG.hero+'\');background-position:60% center;background-size:cover;background-repeat:no-repeat;height:430px;padding:0;vertical-align:middle;">' +
      '<table role="presentation" width="100%" style="width:100%;border-collapse:collapse;"><tr>' +
        '<td class="hero-mobile-copy" style="width:48%;padding:22px 6px 18px 30px;vertical-align:middle;text-align:left;box-sizing:border-box;">' +
          '<div class="hero-mobile-title" style="display:inline-block;background:#efc94f;color:#302a59;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:17px;font-weight:700;letter-spacing:1px;padding:4px 8px;">FALTAM</div>' +
          '<div style="white-space:nowrap;line-height:1;margin-top:2px;">' +
            '<span class="hero-mobile-number" style="display:inline-block;vertical-align:middle;font-family:Georgia,Times New Roman,serif;font-size:82px;line-height:74px;font-weight:400;color:#342f63;">61</span>' +
            '<span class="hero-mobile-days" style="display:inline-block;vertical-align:middle;background:#efc94f;color:#342f63;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:16px;font-weight:700;letter-spacing:1px;padding:4px 8px;margin-left:2px;">DIAS</span>' +
          '</div>' +
          '<div class="hero-mobile-enem" style="font-family:Brush Script MT,Segoe Print,cursive;font-size:25px;line-height:27px;font-style:italic;color:#342f63;margin-top:-2px;">PARA O ENEM!</div>' +
          '<div class="hero-mobile-subtitle" style="font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:15px;font-weight:700;color:#18151f;margin-top:8px;text-shadow:0 1px 1px #ffffff;">61 dias. 6 momentos. 1 objetivo.</div>' +
          '<div class="hero-mobile-body" style="font-family:Arial,Helvetica,sans-serif;font-size:10px;line-height:14px;color:#18151f;margin-top:6px;text-shadow:0 1px 1px #ffffff;">A reta final chegou. Entre conteúdos, revisões e simulados, também existe uma rotina que precisa caber nos seus dias.</div>' +
          '<div class="hero-mobile-final" style="display:inline-block;font-family:Brush Script MT,Segoe Print,cursive;font-size:12px;line-height:15px;font-style:italic;color:#342f63;margin-top:7px;border-bottom:2px solid #d99354;padding-bottom:1px;text-shadow:0 1px 1px #ffffff;">Você não precisa passar por isso no automático. ♡</div>' +
        '</td>' +
        '<td style="width:52%;padding:0;">&nbsp;</td>' +
      '</tr></table>' +
    '</td>' +
  '</tr>' +
...
function attributeCell_(title, sub, cidKey) {
  return '<td class="attribute-cell" style="width:16.66%;padding:8px 5px;text-align:center;vertical-align:top;box-sizing:border-box;">' +
...
function validarTemplateEnem61Dias_() {
  ...
  var forbidden = /<td[^>]*class="[^"]*(stack100|product-cell|benefit-cell|footer-col|menu-cell|attribute-cell)[^"]*"[^>]*\swidth=/i;
  if (forbidden.test(html)) throw new Error('Falha regra 21: TD responsiva contém atributo HTML width.');

  // Regras 20/22: hero mobile independente e com tipografia própria.
  [
   '.hero-desktop{display:none!important;max-height:0!important;overflow:hidden!important;mso-hide:all!important;}',
   '.hero-mobile{display:table-row!important;max-height:none!important;overflow:visible!important;}',
   '.hero-mobile-cell{display:table-cell!important;height:430px!important;background-position:60% center!important;background-size:cover!important;background-repeat:no-repeat!important;}',
   ...
   '.hero-mobile-final{font-size:12px!important;line-height:15px!important;color:#342f63!important;font-family:Brush Script MT,Segoe Print,cursive!important;text-shadow:0 1px 1px #ffffff!important;}'
    ...
    if (html.indexOf(rule) === -1) throw new Error('Falha regras 20/22: regra do hero mobile independente ausente.');
  });

  if (html.indexOf('class="hero-desktop"') === -1 || html.indexOf('class="hero-mobile"') === -1) {
    throw new Error('Hero responsivo: versões desktop/mobile independentes não encontradas.');
  }
