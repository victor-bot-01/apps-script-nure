...
function blocoTituloProdutosRockInRio2026_() {
  ...
  html.push('<div class="section-title" style="font-family:Georgia,\'Times New Roman\',serif;font-size:29px;line-height:35px;font-weight:700;color:#171922;margin:0 0 7px 0;">6 fragrâncias para entrar no ritmo da noite</div>');
