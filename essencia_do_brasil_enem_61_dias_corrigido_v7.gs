...
function criarTemplateEnem61Dias_() {
  ...
  var URLS = {
    ...
    iconOil: 'https://img.icons8.com/ios/50/4d2e62/water.png',
    iconEssence: 'https://img.icons8.com/ios/50/4d2e62/perfume-bottle.png',
  ...
  + '.cta-col{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;padding:16px 20px!important;text-align:center!important;border-left:0!important;border-right:0!important;border-top:1px solid #d5c7df!important;}'
  + '.cta-first{border-top:0!important;}'
  + '.cta-inner td{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;text-align:center!important;padding:0!important;}'
  + '.cta-icon{display:block!important;margin:0 auto 10px auto!important;text-align:center!important;}'
  ...
  + '<table class="cta-inner" width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="width:100%;table-layout:fixed;">'
  + '<tr>'
  + '<td class="cta-icon" valign="middle" style="width:28%;padding:0 10px 0 0;text-align:center;">'
  + '<img src="https://i.ibb.co/m55t1QFb/icone-presente-email.png" width="58" height="58" alt="" style="display:block;width:58px;height:58px;max-width:100%;margin:0 auto;border:0;">'
  + '</td>'
  + '<td class="cta-text" valign="middle" style="width:72%;padding:0;text-align:left;">'
  ...
  + '<table class="cta-inner" width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="width:100%;table-layout:fixed;">'
  + '<tr>'
  + '<td class="cta-icon" valign="middle" style="width:30%;padding:0 10px 0 0;text-align:center;">'
  + '<img src="https://i.ibb.co/vCgRfYZ4/icone-cerebro-email.png" width="58" height="58" alt="" style="display:block;width:58px;height:58px;max-width:100%;margin:0 auto;border:0;">'
  + '</td>'
  + '<td class="cta-text" valign="middle" style="width:70%;padding:0;text-align:center;">'
...
function validarTemplateEnem61Dias() {
  ...
  exigir(html.indexOf('https://i.ibb.co/m55t1QFb/icone-presente-email.png') !== -1, 'URL pública do ícone presente ausente.');
  exigir(html.indexOf('https://i.ibb.co/vCgRfYZ4/icone-cerebro-email.png') !== -1, 'URL pública do ícone cérebro ausente.');
