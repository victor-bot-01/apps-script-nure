...
@media only screen and (max-width:920px){
  ...
  .hero-copy{width:58%!important;background-color:#193c2f!important;padding:28px 18px 28px 22px!important;box-sizing:border-box!important;}
  .hero-spacer{width:42%!important;}
...
<img src="cid:hdrQuality" width="34" height="34" alt="" style="display:block;width:34px;height:34px;max-width:100%;margin:0 auto 3px 73px;border:0;">
...
<!-- hero -->
<tr><td background="https://i.ibb.co/XkMZQmwD/Chat-GPT-Image-3-de-set-de-2026-18-59-39.png" bgcolor="#e7ddcb" valign="middle" style="padding:0;background-color:#e7ddcb;background-image:url('https://i.ibb.co/XkMZQmwD/Chat-GPT-Image-3-de-set-de-2026-18-59-39.png');background-repeat:no-repeat;background-position:center center;background-size:cover;">
...
<table class="hero-split" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;border-collapse:collapse;">
<tr>
...
<td class="hero-spacer" style="width:60%;padding:0;font-size:0;line-height:0;">&nbsp;</td>
</tr></table>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;table-layout:fixed;border-collapse:collapse;">
<tr><td width="26%" valign="middle" style="width:26%;padding:0 12px;"><div style="height:1px;background-color:#9d927d;font-size:1px;line-height:1px;">&nbsp;</div></td><td width="48%" align="center" style="width:48%;padding:0 6px;"><div class="section-title" style="font-family:Georgia,'Times New Roman',serif;font-size:20px;line-height:25px;color:#1b2e25;letter-spacing:1px;white-space:nowrap;">CONHEÇA AS 6 COMPOSIÇÕES</div></td><td width="26%" valign="middle" style="width:26%;padding:0 12px;"><div style="height:1px;background-color:#9d927d;font-size:1px;line-height:1px;">&nbsp;</div></td></tr>
</table>
</td></tr>
...
'https://i.ibb.co/XkMZQmwD/Chat-GPT-Image-3-de-set-de-2026-18-59-39.png',
  ...
  var classesResponsivas = ['stack100','header-col','menu-cell','benefit-cell','product-cell','secondary-col','offer-cell','footer-col','bottom-col','hero-copy','hero-spacer'];
