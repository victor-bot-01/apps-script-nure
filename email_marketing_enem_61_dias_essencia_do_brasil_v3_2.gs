...
function templateEnem61Dias_() {
  ...
  var css = '<style>' +
    '@media only screen and (max-width:920px){' +
      ...
      '.hero-title{font-size:27px!important;line-height:29px!important;color:#20182d!important;letter-spacing:0!important;font-family:Arial,Helvetica,sans-serif!important;font-weight:700!important;}' +
      '.hero-subtitle{font-size:15px!important;line-height:20px!important;color:#20182d!important;font-family:Arial,Helvetica,sans-serif!important;font-weight:700!important;}' +
      '.hero-body{font-size:13px!important;line-height:18px!important;color:#20182d!important;font-family:Arial,Helvetica,sans-serif!important;}' +
  ...
  '<tr><td background="'+IMG.hero+'" style="background-image:url(\''+IMG.hero+'\');background-position:center center;background-size:cover;background-repeat:no-repeat;height:500px;padding:0;vertical-align:middle;">' +
    ...
    '<table role="presentation" width="100%" style="width:100%;border-collapse:collapse;"><tr>' +
      '<td class="hero-copy" style="width:41%;padding:30px 24px 30px 32px;vertical-align:middle;box-sizing:border-box;background:transparent;">' +
        '<div class="hero-title" style="font-family:Arial,Helvetica,sans-serif;font-size:29px;line-height:31px;font-weight:700;letter-spacing:0;color:#20182d;text-transform:uppercase;">FALTAM 61 DIAS<br>PARA O ENEM.</div>' +
        '<div class="hero-subtitle" style="font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:20px;font-weight:700;color:#20182d;margin-top:12px;">61 dias. 6 momentos. 1 objetivo.</div>' +
        '<div class="hero-body" style="font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#20182d;margin-top:12px;">A reta final chegou. Entre conteúdos, revisões e simulados, também existe uma rotina que precisa caber nos seus dias.</div>' +
        '<div class="hero-body" style="font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:18px;color:#20182d;font-weight:700;margin-top:10px;">Você não precisa passar por isso no automático.</div>' +
      '</td>' +
