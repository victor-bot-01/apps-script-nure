...
function templateEnem61Dias_() {
  ...
  var css = '<style>' +
    '@media only screen and (max-width:920px){' +
      ...
      '.hero-title{font-size:14px!important;line-height:17px!important;color:#2e2438!important;font-family:Brush Script MT,Segoe Print,cursive!important;font-weight:400!important;font-style:italic!important;}' +
      ...
      '.hero-number{font-size:68px!important;line-height:62px!important;color:#3f3156!important;}' +
      '.hero-days{font-size:13px!important;line-height:16px!important;padding:3px 7px!important;}' +
      '.hero-enem{font-size:25px!important;line-height:28px!important;color:#3f3156!important;}' +
      '.hero-final{font-size:13px!important;line-height:17px!important;color:#3f3156!important;}' +
  ...
  '<tr><td background="'+IMG.hero+'" style="background-image:url(\''+IMG.hero+'\');background-position:center center;background-size:cover;background-repeat:no-repeat;height:500px;padding:0;vertical-align:middle;">' +
    ...
    '<table role="presentation" width="100%" style="width:100%;border-collapse:collapse;"><tr>' +
      '<td class="hero-copy" style="width:41%;padding:25px 20px 24px 34px;vertical-align:middle;box-sizing:border-box;background:transparent;">' +
        '<div class="hero-title" style="font-family:Brush Script MT,Segoe Print,cursive;font-size:18px;line-height:21px;font-weight:400;font-style:italic;color:#2e2438;transform:rotate(-3deg);transform-origin:left center;">Faltam</div>' +
        '<table role="presentation" width="100%" style="width:100%;border-collapse:collapse;"><tr>' +
          '<td style="padding:0;vertical-align:middle;"><div class="hero-number" style="font-family:Georgia,Times New Roman,serif;font-size:92px;line-height:82px;font-weight:400;color:#3f3156;">61</div></td>' +
          '<td style="padding:8px 0 0 6px;vertical-align:middle;"><span class="hero-days" style="display:inline-block;background:#e6c25d;color:#3f3156;font-family:Arial,Helvetica,sans-serif;font-size:15px;line-height:18px;font-weight:700;letter-spacing:1px;padding:4px 9px;transform:rotate(-2deg);">DIAS</span></td>' +
        '</tr></table>' +
        '<div class="hero-enem" style="font-family:Brush Script MT,Segoe Print,cursive;font-size:31px;line-height:34px;font-weight:400;font-style:italic;color:#3f3156;transform:rotate(-2deg);transform-origin:left center;margin-top:-3px;">PARA O ENEM!</div>' +
        '<div class="hero-subtitle" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:17px;font-weight:400;color:#2e2438;margin-top:12px;">61 dias. 6 momentos. 1 objetivo.</div>' +
        '<div class="hero-body" style="font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:16px;color:#2e2438;margin-top:8px;">A reta final chegou. Entre conteúdos, revisões e simulados, também existe uma rotina que precisa caber nos seus dias.</div>' +
        '<div class="hero-final" style="display:inline-block;font-family:Brush Script MT,Segoe Print,cursive;font-size:15px;line-height:19px;font-style:italic;color:#3f3156;margin-top:9px;border-bottom:2px solid #d99354;padding-bottom:2px;transform:rotate(-1deg);">Você não precisa passar por isso no automático. ♡</div>' +
      '</td>' +
