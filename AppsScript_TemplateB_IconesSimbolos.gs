...
function montarHtmlIconesSimbolos(d) {
  ...
  const blocoPresenteie =
    '<tr><td style="background-color:' + corVerdeEscuro2 + ';padding:24px;">' +
      '<table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr>' +
        '<td width="34%" valign="middle" class="stack100" style="padding-right:20px;">' + imagemOuPlaceholder(LINK_BANNER_PRESENTEIE_ICONES_SIMBOLOS, 190, 190, '[ foto da caixa-presente ]') + '</td>' +
