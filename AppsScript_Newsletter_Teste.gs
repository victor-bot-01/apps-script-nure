...
const TEXTO_PADRAO_PEDIR_PRODUTOS =
  ...
  '\n' +
  'Para cada produto, me devolva nessa ordem:\n' +
  'Nome do produto (exatamente como aparece no site)\n' +
  'Preço original\n' +
  'Preço com desconto (se houver; se não houver, deixe em branco)\n' +
  'Observação (se houver - por exemplo "Compre 4, pague 3", frete grátis,\n' +
  'brinde, ou qualquer outra condição especial mostrada no anúncio; se não\n' +
  'houver, deixe em branco)\n' +
  '\n' +
  'Formato de entrega: lista simples, um produto após o outro, separados por\n' +
  'linha em branco entre eles, pronta pra eu copiar e colar - sem numeração,\n' +
