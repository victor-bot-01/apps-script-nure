...
const TEXTO_PADRAO_PEDIR_TEXTOS =
  'Preciso dos textos de uma campanha de e-mail marketing pro tema que vou\n' +
  'te passar, pra Essência do Brasil (perfumaria natural, óleos essenciais).\n' +
  '\n' +
  ...
  'RODAPÉ TEXTO (até 90 caracteres)\n' +
  '\n' +
...
const TEXTO_PADRAO_PEDIR_BANNER_HERO =
  ...
  'banner do hero de uma campanha de e-mail marketing da Essência do Brasil\n' +
  '(perfumaria natural, óleos essenciais). Eu vou te passar o tema da\n' +
  'campanha e de 1 a 3 produtos (nome + foto de referência de cada um,\n' +
  'tirada do site).\n' +
  '\n' +
  ...
  'extras antes ou depois), e me lembre de anexar as fotos de referência\n' +
  'dos produtos junto quando eu for usar.';
...
const TEXTO_PADRAO_PEDIR_BANNER_FAIXA =
  ...
  'faixa larga (banner decorativo, sem produto e sem texto) de uma campanha\n' +
  'de e-mail marketing da Essência do Brasil (perfumaria natural, óleos\n' +
  'essenciais). Eu vou te passar só o tema da campanha.\n' +
  '\n' +
  'O prompt final deve ser em inglês, pronto pra eu copiar e colar direto\n' +
...
const TEXTO_PADRAO_PEDIR_BANNER_SOBRE =
  ...
  'marca específico e sem texto) de uma campanha de e-mail marketing da\n' +
  'Essência do Brasil (perfumaria natural, óleos essenciais). Eu vou te\n' +
  'passar só o tema da campanha.\n' +
  '\n' +
  'O prompt final deve ser em inglês, pronto pra eu copiar e colar direto\n' +
  'numa IA de geração de imagem (tipo Bing Image Creator) - aqui NÃO precisa\n' +
...
function criarAbaTemplade() {
  ...
  sheet.getRange('A38').setFontWeight('bold');
  ...
  sheet.setRowHeight(14, 780);
  sheet.setRowHeight(15, 460);
  sheet.setRowHeight(16, 460);
  sheet.setRowHeight(27, 260);
