  ...
  const cardReal = function(produto) {
    ...
    return (
      '<table role="presentation" width="100%" cellpadding="0" cellspacing="0">' +
        ...
        '<tr><td align="center" style="padding:6px 8px 4px;font-family:Arial,sans-serif;font-size:14px;font-weight:bold;color:' + corDourado + ';">' + precoFormatado + '</td></tr>' +
        '<tr><td align="center" style="padding-bottom:14px;font-family:Arial,sans-serif;font-size:11px;color:#5a5648;">produto real (planilha)</td></tr>' +
        '<tr><td align="center">' +
          '<table role="presentation" cellpadding="0" cellspacing="0"><tr><td style="border:1px solid ' + corDourado + ';border-radius:16px;padding:6px 18px;">' +
...
'<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:100%;background-color:#ffffff;">' +
  ...
  '<tr><td style="padding:28px 24px 8px;">' +
    ...
    '<table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr>' +
      '<td width="33%" valign="top">' + primeiroCard + '</td>' +
      '<td width="4%"></td>' +
