...
const IMAGEM_BLOCO_INSTITUCIONAL_SETEMBRO_2026 = ''; // Se desejar trocar o ícone por uma imagem pública, cole a URL aqui.
...
const ICONES_BASE64_SETEMBRO_2026 = {
  ...
  icoLeafDark: '',
  ...
  icoCareLight: '',
...
<head>
  ...
  <style>
    @media only screen and (max-width:920px) {
      ...
      .hero-surface{height:410px!important;background-size:cover!important;background-position:68% center!important;}
      .hero-overlay{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;padding:18px 14px 18px!important;}
      .hero-panel{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;padding:16px 16px 16px!important;}
      ...
      .hero-body{font-size:14px!important;line-height:21px!important;color:#244937!important;}
      .hero-body-secondary{font-size:13px!important;line-height:19px!important;color:#365443!important;}
                ...
                <tr>
                  <td class="menu-cell" style="width:16.66%;padding:13px 5px;text-align:center;vertical-align:middle;">
                    <a href="${U.perfumesMasculinos}" style="color:#111111;text-decoration:none;font-size:10px;line-height:14px;font-weight:bold;">
                      <img src="cid:icoPerfumeDark" width="18" height="18" alt="" style="display:block;margin:0 auto 5px;max-width:100%;border:0;">PERFUMES<br>MASCULINOS
                    </a>
                  </td>
                  <td class="menu-cell" style="width:16.66%;padding:13px 5px;text-align:center;vertical-align:middle;border-left:1px solid #eadfc9;">
                    <a href="${U.perfumesFemininos}" style="color:#111111;text-decoration:none;font-size:10px;line-height:14px;font-weight:bold;">
                      <img src="cid:icoPerfumeDark" width="18" height="18" alt="" style="display:block;margin:0 auto 5px;max-width:100%;border:0;">PERFUMES<br>FEMININOS
                    </a>
                  </td>
                  <td class="menu-cell" style="width:16.66%;padding:13px 5px;text-align:center;vertical-align:middle;border-left:1px solid #eadfc9;">
                    <a href="${U.oleosEssenciais}" style="color:#111111;text-decoration:none;font-size:10px;line-height:14px;font-weight:bold;">
                      <img src="cid:icoDropDark" width="18" height="18" alt="" style="display:block;margin:0 auto 5px;max-width:100%;border:0;">ÓLEOS<br>ESSENCIAIS
                    </a>
                  </td>
                  <td class="menu-cell" style="width:16.66%;padding:13px 5px;text-align:center;vertical-align:middle;border-left:1px solid #eadfc9;">
                    <a href="${U.essencias}" style="color:#111111;text-decoration:none;font-size:10px;line-height:14px;font-weight:bold;">
                      <img src="cid:icoAromaDark" width="18" height="18" alt="" style="display:block;margin:0 auto 5px;max-width:100%;border:0;">ESSÊNCIAS
                    </a>
                  </td>
                  <td class="menu-cell" style="width:16.66%;padding:13px 5px;text-align:center;vertical-align:middle;border-left:1px solid #eadfc9;">
                    <a href="${U.cremesSeruns}" style="color:#111111;text-decoration:none;font-size:10px;line-height:14px;font-weight:bold;">
                      <img src="cid:icoSerumDark" width="18" height="18" alt="" style="display:block;margin:0 auto 5px;max-width:100%;border:0;">CREMES E<br>SÉRUNS
                    </a>
                  </td>
                  <td class="menu-cell" style="width:16.66%;padding:13px 5px;text-align:center;vertical-align:middle;border-left:1px solid #eadfc9;">
                    <a href="${U.ofertas}" style="color:#111111;text-decoration:none;font-size:10px;line-height:14px;font-weight:bold;">
                      <img src="cid:icoTagDark" width="18" height="18" alt="" style="display:block;margin:0 auto 5px;max-width:100%;border:0;">OFERTAS
                    </a>
                  </td>
                </tr>
              </table>
                ...
                <tr>
                  <td style="padding:28px 0 24px;vertical-align:top;">
                    <table width="100%" data-layout="fluid-exception" role="presentation" cellspacing="0" cellpadding="0" border="0" style="width:100%;border-collapse:collapse;table-layout:fixed;">
                      <tr>
                        <td class="hero-overlay" style="width:43%;padding:0 0 0 34px;vertical-align:top;box-sizing:border-box;">
                          <div class="hero-panel" style="background-color:rgba(247,241,231,0.88);padding:20px 20px 18px 20px;box-sizing:border-box;">
                            ...
                            <div class="hero-title" style="font-family:Georgia,'Times New Roman',serif;font-size:39px;line-height:43px;color:#0b3a25;font-weight:bold;margin-bottom:16px;">
                              O Brasil também se revela pelo aroma
                            </div>
                            <div class="hero-body" style="font-size:16px;line-height:24px;color:#253d31;margin-bottom:14px;">
                            ...
                            <div class="hero-body-secondary" style="font-size:14px;line-height:20px;color:#375444;margin-bottom:20px;">
                        ...
                        <td style="width:57%;padding:0;">&nbsp;</td>
                      </tr>
                    </table>
                  </td>
                </tr>
              ...
              <table width="100%" role="presentation" cellspacing="0" cellpadding="0" border="0" style="width:100%;table-layout:fixed;border-collapse:collapse;background-color:#0f432b;">
                <tr>
                  <td class="benefit-cell" style="width:25%;padding:15px 12px;vertical-align:middle;text-align:center;color:#ffffff;">
                    <img src="cid:icoLeafLight" width="20" height="20" alt="" style="display:inline-block;vertical-align:middle;max-width:100%;border:0;margin-right:7px;">
                  ...
                  <td class="benefit-cell" style="width:25%;padding:15px 12px;vertical-align:middle;text-align:center;color:#ffffff;border-left:1px solid #436653;">
                    <img src="cid:icoSparkLight" width="20" height="20" alt="" style="display:inline-block;vertical-align:middle;max-width:100%;border:0;margin-right:7px;">
                    <span style="font-size:11px;line-height:16px;font-weight:bold;">FRAGRÂNCIAS NATURAIS<br>E SOFISTICADAS</span>
                  </td>
                  <td class="benefit-cell" style="width:25%;padding:15px 12px;vertical-align:middle;text-align:center;color:#ffffff;border-left:1px solid #436653;">
                    <img src="cid:icoGiftLight" width="20" height="20" alt="" style="display:inline-block;vertical-align:middle;max-width:100%;border:0;margin-right:7px;">
                    <span style="font-size:11px;line-height:16px;font-weight:bold;">COMPRE 4<br>E PAGUE 3</span>
                  </td>
                  <td class="benefit-cell" style="width:25%;padding:15px 12px;vertical-align:middle;text-align:center;color:#ffffff;border-left:1px solid #436653;">
                    <img src="cid:icoCareLight" width="20" height="20" alt="" style="display:inline-block;vertical-align:middle;max-width:100%;border:0;margin-right:7px;">
              ...
              <table width="100%" role="presentation" cellspacing="0" cellpadding="0" border="0" style="width:100%;table-layout:fixed;border-collapse:collapse;border:1px solid #d9ccb4;background-color:#fbf7ef;">
                <tr>
                    ...
                    <table width="100%" role="presentation" cellspacing="0" cellpadding="0" border="0" style="width:100%;table-layout:fixed;border-collapse:collapse;">
                      <tr>
                        <td width="28%" style="width:28%;padding:0 10px 0 0;vertical-align:middle;text-align:center;">
                          ${IMAGEM_BLOCO_INSTITUCIONAL_SETEMBRO_2026 ? `<img src="${IMAGEM_BLOCO_INSTITUCIONAL_SETEMBRO_2026}" width="64" alt="" style="display:block;margin:0 auto;max-width:100%;border:0;">` : `<img src="cid:icoBrazilDark" width="40" height="40" alt="" style="display:block;margin:0 auto;max-width:100%;border:0;">`}
                        </td>
                  ...
                  <td class="institution-cell" style="width:20%;padding:18px 10px;vertical-align:middle;text-align:center;border-left:1px solid #d9ccb4;">
                    <img src="cid:icoBottleDark" width="24" height="24" alt="" style="display:block;margin:0 auto 7px;max-width:100%;border:0;">
                    <div style="font-size:10px;line-height:14px;color:#1d3026;font-weight:bold;">PERFUMARIA NATURAL<br>COM IDENTIDADE</div>
                  </td>
                  <td class="institution-cell" style="width:20%;padding:18px 10px;vertical-align:middle;text-align:center;border-left:1px solid #d9ccb4;">
                    <img src="cid:icoSproutDark" width="24" height="24" alt="" style="display:block;margin:0 auto 7px;max-width:100%;border:0;">
                    <div style="font-size:10px;line-height:14px;color:#1d3026;font-weight:bold;">SOFISTICAÇÃO INSPIRADA<br>NA NATUREZA</div>
                  </td>
                  <td class="institution-cell" style="width:20%;padding:18px 10px;vertical-align:middle;text-align:center;border-left:1px solid #d9ccb4;">
                    <img src="cid:icoPeopleDark" width="24" height="24" alt="" style="display:block;margin:0 auto 7px;max-width:100%;border:0;">
              ...
              <table width="100%" role="presentation" cellspacing="0" cellpadding="0" border="0" style="width:100%;table-layout:fixed;border-collapse:collapse;">
                <tr>
                  ...
                  <td class="footer-col" style="width:25%;padding:22px 18px;vertical-align:top;color:#ffffff;border-left:1px solid #4a6a58;">
                    <img src="cid:icoContactLight" width="20" height="20" alt="" style="display:block;margin-bottom:7px;max-width:100%;border:0;">
                  ...
                  <td class="footer-col" style="width:25%;padding:22px 18px;vertical-align:top;color:#ffffff;border-left:1px solid #4a6a58;">
                    <img src="cid:icoSocialLight" width="20" height="20" alt="" style="display:block;margin-bottom:7px;max-width:100%;border:0;">
                  ...
                  <td class="footer-col" style="width:25%;padding:22px 18px;vertical-align:top;color:#ffffff;border-left:1px solid #4a6a58;">
                    <img src="cid:icoPaymentLight" width="20" height="20" alt="" style="display:block;margin-bottom:7px;max-width:100%;border:0;">
              ...
              <table width="100%" role="presentation" cellspacing="0" cellpadding="0" border="0" style="width:100%;table-layout:fixed;border-collapse:collapse;">
                <tr>
                  <td class="hide-mobile" width="12%" style="width:12%;padding:10px;text-align:center;vertical-align:middle;">
                    <img src="cid:icoLeafDark" width="18" height="18" alt="" style="display:block;margin:0 auto;max-width:100%;border:0;">
                  </td>
