...
function templateEnem61Dias_() {
  ...
  var IMG = {
    ...
    heroMobile: 'https://i.ibb.co/bMhjZnrr/hero-enem-mobile-aprovado-crop.jpg',
  ...
  var css = '<style>' +
    '@media only screen and (max-width:920px){' +
      ...
      '.hero-mobile-cell{display:table-cell!important;background-size:100% 100%!important;background-position:center center!important;background-repeat:no-repeat!important;height:490px!important;}' +
      '.hero-mobile-copy{width:42%!important;max-width:42%!important;box-sizing:border-box!important;padding:32px 4px 18px 34px!important;text-align:left!important;vertical-align:top!important;}' +
      ...
      '.hero-days{font-size:14px!important;line-height:17px!important;padding:4px 8px!important;margin-left:2px!important;}' +
  ...
  // 4B. Hero exclusivo mobile — imagem dedicada 900x490.
  '<tr class="hero-mobile" style="display:none;max-height:0;overflow:hidden;mso-hide:all;">' +
    '<td class="hero-mobile-cell" background="'+IMG.heroMobile+'" style="display:none;background-image:url(\''+IMG.heroMobile+'\');background-size:100% 100%;background-position:center center;background-repeat:no-repeat;height:490px;padding:0;vertical-align:top;">' +
      '<table role="presentation" width="100%" style="width:100%;border-collapse:collapse;"><tr>' +
        '<td class="hero-mobile-copy" style="width:42%;padding:32px 4px 18px 34px;vertical-align:top;text-align:left;box-sizing:border-box;">' +
          '<div style="display:inline-block;background:#efc94f;color:#34315f;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:16px;font-weight:700;letter-spacing:1px;padding:4px 8px;">FALTAM</div>' +
          '<div style="white-space:nowrap;line-height:1;margin-top:2px;">' +
            '<span style="display:inline-block;vertical-align:middle;font-family:Georgia,Times New Roman,serif;font-size:78px;line-height:70px;font-weight:400;color:#34315f;">61</span>' +
            '<span style="display:inline-block;vertical-align:middle;background:#efc94f;color:#34315f;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:15px;font-weight:700;letter-spacing:1px;padding:4px 7px;margin-left:2px;">DIAS</span>' +
          '</div>' +
          '<div style="font-family:Brush Script MT,Segoe Print,cursive;font-size:23px;line-height:25px;font-style:italic;color:#34315f;margin-top:-2px;">PARA O ENEM!</div>' +
          '<div style="font-family:Arial,Helvetica,sans-serif;font-size:10px;line-height:14px;font-weight:700;color:#17131f;margin-top:8px;">61 dias. 6 momentos. 1 objetivo.</div>' +
          '<div style="font-family:Arial,Helvetica,sans-serif;font-size:9px;line-height:13px;color:#17131f;margin-top:5px;">A reta final chegou. Entre conteúdos, revisões e simulados, também existe uma rotina que precisa caber nos seus dias.</div>' +
          '<div style="display:inline-block;font-family:Brush Script MT,Segoe Print,cursive;font-size:11px;line-height:14px;font-style:italic;color:#34315f;margin-top:6px;border-bottom:2px solid #d99354;padding-bottom:1px;">Você não precisa passar por isso no automático. ♡</div>' +
        '</td>' +
...
function validarTemplateEnem61Dias_() {
  ...
  if (!t.images || !t.images.heroMobile || html.indexOf(t.images.heroMobile) === -1) {
    throw new Error('Hero mobile público ausente.');
  }
  if (html.indexOf('class="hero-desktop"') === -1 || html.indexOf('class="hero-mobile"') === -1) {
    throw new Error('Heroes desktop/mobile independentes ausentes.');
  }
