...
<head>
  ...
  <style>
    @media only screen and (max-width:920px) {
      ...
      .institution-main{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;padding:28px 24px 26px!important;}
      .institution-art-cell{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;padding:0 0 22px!important;text-align:center!important;}
      .institution-text-cell{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;padding:0 8px!important;text-align:center!important;}
      .institution-art{display:block!important;width:100px!important;max-width:100px!important;height:auto!important;margin:0 auto!important;}
      .institution-title{font-size:25px!important;line-height:30px!important;text-align:center!important;margin-bottom:12px!important;}
      .institution-body{font-size:15px!important;line-height:23px!important;text-align:center!important;}
      ...
      .hero-surface{height:540px!important;background-size:cover!important;background-position:64% center!important;background-image:linear-gradient(90deg,rgba(7,49,32,.84) 0%,rgba(7,49,32,.68) 44%,rgba(7,49,32,.24) 68%,rgba(7,49,32,0) 100%),url('${F.hero}')!important;}
      .hero-overlay{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;padding:30px 20px 24px 28px!important;}
      .hero-panel{display:block!important;width:70%!important;max-width:70%!important;box-sizing:border-box!important;padding:0!important;margin:0!important;background:transparent!important;}
      ...
      .hero-eyebrow{font-size:15px!important;line-height:19px!important;color:#fff5cf!important;text-shadow:0 1px 3px rgba(0,0,0,.55)!important;}
      .hero-title{font-size:28px!important;line-height:32px!important;color:#ffffff!important;text-shadow:0 2px 4px rgba(0,0,0,.62)!important;}
      .hero-body{font-size:14px!important;line-height:21px!important;color:#ffffff!important;text-shadow:0 1px 3px rgba(0,0,0,.62)!important;}
      .hero-body-secondary{font-size:12px!important;line-height:18px!important;color:#f7f1df!important;text-shadow:0 1px 3px rgba(0,0,0,.62)!important;}
              ...
              <table width="100%" role="presentation" cellspacing="0" cellpadding="0" border="0" style="width:100%;table-layout:fixed;border-collapse:collapse;border:1px solid #d9ccb4;background-color:#fbf7ef;">
                <tr>
                  <td class="institution-main" style="width:40%;padding:18px 20px;vertical-align:middle;">
                    <table width="100%" role="presentation" cellspacing="0" cellpadding="0" border="0" style="width:100%;table-layout:fixed;border-collapse:collapse;">
                      <tr>
                        <td class="institution-art-cell" width="28%" style="width:28%;padding:0 10px 0 0;vertical-align:middle;text-align:center;">
                        ...
                        <td class="institution-text-cell" width="72%" style="width:72%;padding:0;vertical-align:middle;">
                          <div class="institution-title" style="font-family:Georgia,'Times New Roman',serif;font-size:16px;line-height:20px;color:#173e2c;font-weight:bold;margin-bottom:5px;">SOMOS FEITOS DE NATUREZA, LUZ E IDENTIDADE</div>
                          <div class="institution-body" style="font-size:10px;line-height:15px;color:#263a2f;">Neste 7 de Setembro, celebramos um Brasil que inspira pela biodiversidade, pela energia e pela capacidade de transformar natureza em beleza, cuidado e expressão.</div>
                        </td>
                      </tr>
                    </table>
                  </td>
