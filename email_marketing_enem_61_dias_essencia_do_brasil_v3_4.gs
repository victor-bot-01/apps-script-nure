...
function templateEnem61Dias_() {
  ...
  var css = '<style>' +
    '@media only screen and (max-width:920px){' +
      ...
      '.hero-title{font-size:20px!important;line-height:22px!important;color:#2f2858!important;font-family:Brush Script MT,Segoe Print,cursive!important;font-weight:400!important;font-style:italic!important;}' +
      ...
      '.hero-days{font-size:14px!important;line-height:17px!important;padding:4px 8px!important;margin-left:-8px!important;}' +
  ...
  '<tr><td background="'+IMG.hero+'" style="background-image:url(\''+IMG.hero+'\');background-position:center center;background-size:cover;background-repeat:no-repeat;height:500px;padding:0;vertical-align:middle;">' +
    ...
    '<table role="presentation" width="100%" style="width:100%;border-collapse:collapse;"><tr>' +
      '<td class="hero-copy" style="width:41%;padding:18px 14px 20px 34px;vertical-align:middle;box-sizing:border-box;background:transparent;">' +
        '<div class="hero-title" style="font-family:Brush Script MT,Segoe Print,cursive;font-size:24px;line-height:26px;font-weight:400;font-style:italic;color:#2f2858;transform:rotate(-3deg);transform-origin:left center;margin-left:16px;margin-bottom:-5px;">Faltam</div>' +
        '<table role="presentation" width="100%" style="width:100%;border-collapse:collapse;"><tr>' +
