...
@media only screen and (max-width:920px){
  ...
  .hero-copy{width:58%!important;padding:28px 18px 28px 24px!important;box-sizing:border-box!important;}
  .hero-art{width:42%!important;box-sizing:border-box!important;}
  .hero-kicker{font-size:10px!important;line-height:14px!important;color:#2b1a12!important;letter-spacing:1.2px!important;}
  .hero-title{font-size:31px!important;line-height:33px!important;color:#2b1a12!important;}
  .hero-script{font-size:32px!important;line-height:34px!important;color:#5c3725!important;}
  .hero-formula{font-size:26px!important;line-height:29px!important;color:#7a4d32!important;}
  .hero-body{font-size:13px!important;line-height:19px!important;color:#2b1a12!important;}
  .hero-products{font-size:10px!important;line-height:15px!important;color:#2b1a12!important;}
  .hero-product-link{color:#2b1a12!important;}
  .hero-button{font-size:10px!important;line-height:14px!important;padding:12px 14px!important;color:#ffffff!important;background-color:#3a2114!important;}
  ...
  <tr>
    <td align="center" style="padding:0;margin:0;">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;max-width:900px;table-layout:fixed;background-color:#fffaf5;margin:0 auto;">
        ...
        <!-- 2. CABEÇALHO / LOGO -->
        <tr>
          <td align="center" style="padding:20px 20px 16px 20px;background-color:#fffaf5;">
            <a href="${U.home}" style="text-decoration:none;color:#17261c;">
              <img src="cid:iconLeaf" width="34" height="34" alt="Essência do Brasil" style="display:block;margin:0 auto 5px auto;max-width:100%;height:auto;">
        ...
        <!-- 4. HERO PRINCIPAL COM FOTO PÚBLICA COMO BACKGROUND -->
        <tr>
          <td background="${U.hero}" style="padding:0;background-color:#f5eee6;background-image:url('${U.hero}');background-repeat:no-repeat;background-position:center center;background-size:cover;">
            <!--[if gte mso 9]>
            <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:900px;height:506px;">
              <v:fill type="frame" src="${U.hero}" color="#f5eee6" />
              <v:textbox inset="0,0,0,0">
            <![endif]-->
            <table class="hero-table" role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;height:506px;">
              <tr>
                <td class="hero-copy" valign="middle" style="width:43%;padding:34px 24px 34px 34px;box-sizing:border-box;vertical-align:middle;">
                  <div class="hero-kicker" style="font-size:11px;line-height:16px;letter-spacing:1.5px;font-weight:bold;color:#4a2c1c;margin:0 0 9px 0;">DUAS PERSONALIDADES. UMA CONEXÃO.</div>
                  <div class="hero-title" style="font-family:Georgia,'Times New Roman',serif;font-size:36px;line-height:39px;font-weight:bold;color:#342017;margin:0;">FELIZ</div>
                  <div class="hero-script" style="font-family:Georgia,'Times New Roman',serif;font-size:38px;line-height:41px;font-style:italic;color:#6b412b;margin:0 0 4px 0;">Dia do Irmão</div>
                  <div class="hero-formula" style="font-family:Georgia,'Times New Roman',serif;font-size:30px;line-height:34px;font-weight:bold;color:#8a5736;margin:0 0 13px 0;">1 + 1 = 3</div>
                  <div class="hero-body" style="font-size:14px;line-height:20px;color:#3c2b23;margin:0 0 13px 0;">Entre irmãos, a soma nunca termina em dois. Há memórias, contrastes e histórias que só existem porque duas pessoas se encontraram.</div>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%;table-layout:fixed;">
              <tr>
                <td class="footer-col" valign="top" style="width:25%;padding:22px 18px;vertical-align:top;box-sizing:border-box;">
                  <img src="cid:iconLeaf" width="28" height="28" alt="Essência do Brasil" style="display:block;margin:0 0 6px 0;max-width:100%;height:auto;">
    ...
    <td class="product-cell" valign="top" style="width:16.66%;padding:6px;vertical-align:top;box-sizing:border-box;">
      <div style="background-color:#fbf6f0;border:1px solid #eee1d6;border-radius:6px;padding:8px 7px 10px 7px;text-align:center;box-sizing:border-box;">
        <a href="${url}" style="text-decoration:none;color:#2f241e;">
          <img class="product-image" src="${foto}" width="112" height="112" alt="${nome}" style="display:block;width:112px;height:112px;max-width:100%;margin:0 auto 8px auto;border:0;">
        </a>
...
function validarTemplateDiaDoIrmao_(html, inlineImages) {
  ...
  if (html.indexOf('.hero-button{font-size:10px!important;line-height:14px!important;padding:12px 14px!important;color:#ffffff!important;background-color:#3a2114!important;}') === -1) {
