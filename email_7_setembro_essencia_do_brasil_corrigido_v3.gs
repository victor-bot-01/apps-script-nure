...
<head>
  ...
  <style>
    @media only screen and (max-width:920px) {
      ...
      .hero-surface{height:430px!important;background-size:cover!important;background-position:62% center!important;}
      .hero-overlay{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;padding:18px 16px 18px!important;}
      .hero-panel{display:block!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;padding:0!important;background:transparent!important;}
                    ...
                    <table width="100%" role="presentation" cellspacing="0" cellpadding="0" border="0" style="width:100%;table-layout:fixed;border-collapse:collapse;">
                      <tr>
                        <td width="28%" style="width:28%;padding:0 10px 0 0;vertical-align:middle;text-align:center;">
                          ${IMAGEM_BLOCO_INSTITUCIONAL_SETEMBRO_2026 ? `<img src="${IMAGEM_BLOCO_INSTITUCIONAL_SETEMBRO_2026}" width="82" alt="" style="display:block;margin:0 auto;max-width:100%;border:0;">` : `<img src="cid:icoBrazilDark" width="56" height="56" alt="" style="display:block;margin:0 auto;max-width:100%;border:0;">`}
                        </td>
